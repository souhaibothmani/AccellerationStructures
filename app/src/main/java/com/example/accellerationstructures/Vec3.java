...
public class Vec3 {
    ...
    /**
     * MIN - Returns a new Vec3 with the minimum of each component.
     * Used to find the minimum corner of a bounding box.
     */
    ...
    /**
     * MAX - Returns a new Vec3 with the maximum of each component.
     * Used to find the maximum corner of a bounding box.
     */
